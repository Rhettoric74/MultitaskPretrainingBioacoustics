...
def build_model(num_classes: int, **overrides):
    ...
    defaults = dict(
        ...
        spec_norm_path="/home/svu/e1583377/MultitaskPretrainingBioacoustics/scripts/power_spec_norm_stats_log_10_non_peak_normalized_XCL.json",
